...
I'm a backend engineer focused on building systems that are **structured, predictable, and efficient**. My work centers on clear API design, robust database modeling, and scalable service architecture. I believe deeply in engineering discipline and that **readable code is always better than clever code.**

* 🧠 **Currently Focused On:**
    * Real-world System Design Principles
    * API Security (OAuth2/JWT) & Caching Patterns
...
All projects emphasize backend clarity, modular design, and the ability to scale.
